...
from handlers import weatherlake_ingestion as hand
...
def weather_lake_ingestion():
    ...
    def check_forecast_data_newness(forecast_file_path, forecast_file_digest):
        return hand.check_forecast_data_newness(forecast_file_path, forecast_file_digest)
    ...
    def archive_raw_forecast_data(forecast_file_path, forecast_file_digest):
        return hand.archive_raw_forecast_data(forecast_file_path, forecast_file_digest)
    ...
    def process_forecast_data(forecast_object_key):
        return hand.process_forecast_data(forecast_object_key)
